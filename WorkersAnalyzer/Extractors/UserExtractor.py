...
if __name__ == '__main__':
    from WorkersAnalyzer.Extractors.GaribaldiExtractor import GaribaldiExtractor as CurrentExtractor
    from WorkersAnalyzer.Core import test_sample
    SamplePage = test_sample(CurrentExtractor.Azienda)

    extractor = UserExtractor( [ CurrentExtractor(page) for page in   SamplePage ])
