...
export default function Navbar() {
  return (
    <NavigationMenu className="border  w-full h-fit justify-between p-2 bg-white shadow-md  ">
      <NavigationMenuList>
        <NavigationMenuItem>
                ...
                <NavigationMenuLink asChild>
                  ...
                  >
                    ...
                    <p className="mx-3 text-sm leading-tight text-muted-foreground">
                      Estrai automaticamente i dati da file di tipo .pdf di diverse aziende d'ambito ospedaliero
                    </p>
                  </a>
                </NavigationMenuLink>
              </li>
              <ListItem href="/buste-paga" title="Estrazione automatica delle buste paga.">
              Questa Funzionalità non è ancora disponibile. Stiamo lavorando per renderla accessibile il prima possibile
              </ListItem>
              <ListItem href="/buste-paga" title="Compilazione automatica di quiz e moduli">
                Questa Funzionalità non è ancora disponibile. Stiamo lavorando per renderla accessibile il prima possibile
              </ListItem>
              <ListItem href="/buste-paga" title="Typography">
